...
class DataStorage:    
    """This moduel provides functionality to upload stock data into the Amazon S3 bucket named stock-market-data7
    """
    # default constructor
    def __init__(self):
    ...
    def upload_file(self):
        ...
        self.s3.Bucket('stock-market-data7').upload_file(Filename='fetched.csv', Key='fetched.csv')
        print(f'The file has been uploaded into S3!')
